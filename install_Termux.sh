...
function AutoInstaller {
	...
	echo "password = CEO_OSINT">>Configuration/Configuration.ini
	...
	printf "\n${WHITE}UPDATE-PASSWORD:${GREEN}CEO_OSINT\n"
...
function installer {
	...
	if [ $confvar == 1 ];
		...
		cd ../
		cd ../
		echo "path = `pwd`">>CEO_OSINT/Configuration/Configuration.ini
		sleep 2
		printf "\n\nSETTING CLI INTERFACE..."
		echo "Mobile">CEO_OSINT/Display/Display.txt
		sleep 2
