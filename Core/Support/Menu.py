...
class Main:
    ...
    def banner():
        ...
        print(Font.Color.GREEN + text
              +
              Font.Color.WHITE + "| A COMPLETE OSINT TOOL:)      " + Font.Color.BANNER + "CODED BY CEO" + Font.Color.RESET + Font.Color.WHITE + "                     \n|                                                                   |")
        print(Font.Color.WHITE + "|[+]" + Font.Color.GREEN + "VERSION:" + version +      Font.Color.WHITE +  "\t\t\tCURRENT-DATE: {}".format(Font.Color.GREEN + Date1) + 
              Font.Color.WHITE + "    |")
        print(
            Font.Color.YELLOW + "|Inspire great minds:02 " + Font.Color.WHITE + "\t\t\tDATE-FORMAT: {}".format(Font.Color.GREEN + Country + Font.Color.YELLOW) + "          \n|Every mind aims, life goes on" + Font.Color.WHITE + "\t\tCLI-LANGUAGE: {}".format(Font.Color.GREEN + Lang + Font.Color.YELLOW) + "       |\n|Get:Hope:Luck                                                      |\n|Time will luck you                                                 |\n|Live:kindness://open.everyone.in/Lucky                        |")
        print(Font.Color.WHITE +
              "---------------------------------------------------------------------")
    ...
    def Mobile_Banner():
        ...
        print(Font.Color.WHITE + "A COMPLETE OSINT TOOL:)      " +
              Font.Color.BANNER + "CODED BY CEO" + Font.Color.RESET)
        print(Font.Color.WHITE + "\n[+]" +
              Font.Color.GREEN + "VERSION:" + version)
        print(
            Font.Color.YELLOW + "Inspire great minds:02\nEvery mind aims, life goes on\nGet:Hope:Luck\nTime will luck you\nLive:kindness://open.everyone.in/Lucky\n")
        ...
        while True:
            try:
                ...
                if (sce == 1):
                    ...
                    Searcher.CEO_OSINT.search(username, Mode)
