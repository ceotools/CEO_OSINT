...
class CEO_OSINT:
    ...
    def search(username, Mode):
        ...
        if opt == 1:
            ...
            CEO_OSINT.Controll(username, nomefile, identity, report, subject,
            ...
            CEO_OSINT.Scraping(report,username,http_proxy,InstagramParams,PostLocations, PostGpsCoordinates,TwitterParams)
        ...
        Recaps = int(input(Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(
                filename, "Default", "Hypo", "None") + Font.Color.GREEN + "[#CEO_OSINT#]" + Font.Color.WHITE + "-->"))
        if Recaps == 1:
            if opt == 1:
        ...
        if count == 1:
            ...
            if choice == 1:
                CEO_OSINT.Google_dork(username)
                CEO_OSINT.Yandex_dork(username)
