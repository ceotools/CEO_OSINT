...
class Menu:
    ...
    def CreateTemplate(Template,Content,filename,htmlcontent,username):
        ...
        <body>
         <p>PDF REPORT FOR {} GRAPH</p>
          <div class = "Metadata">
            ...
            <p>PDF GENERATED BY CEO_OSINT</p>
            <p>GENERATED ON: {}</p>
            <p>CEO_OSINT DOWNLOAD LINK: https//github.com/ceotools/CEO_OSINT</p>
           </div>
            <br>
            {}
        </body>
        ...
        choice = int(input(
                Font.Color.BLUE + "\n[?]" + Font.Color.WHITE + Language.Translation.Translate_Language(langfile, "Transfer", "Question", "None") + Font.Color.GREEN + "[#CEO_OSINT#]" + Font.Color.WHITE + "-->"))
        if choice == 1:
